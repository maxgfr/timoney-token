...
## Tech Stack
maxgfr/timoney-token is built on the following main stack:
...
# Tech Stack File
![](https://img.stackshare.io/repo.svg "repo") [maxgfr/timoney-token](https://github.com/maxgfr/timoney-token)![](https://img.stackshare.io/public_badge.svg "public")
<br/><br/>
...
|:------|:------|:------|:------|:------|:------|
|[ethereumjs-wallet](https://www.npmjs.com/ethereumjs-wallet)|v0.6.0|03/17/18|Maxime Golfier |MIT|N/A|
|[truffle-hdwallet-provider](https://www.npmjs.com/truffle-hdwallet-provider)|v0.0.3|03/17/18|Maxime Golfier |MIT|N/A|
